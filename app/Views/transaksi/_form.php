                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-xs-12 control-label">     
                                        <div class="input-group">
                                            <input type="datetime-local" name="tanggal" value="<?= substr($model['tanggal'], 0, 10) ?>" class="form-control" autofocus/>
                        ...
                        <div class="col-md-12">
                            <div class="panel-body form-group-separated">          
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-xs-12 control-label">     
                                        <div class="input-group">
                                            <input type="number" name="jumlah" value="<?= $model['jumlah'] ?>" class="form-control" autofocus/>
                                            <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                        </div>
                                    </div>
                                </div>        
